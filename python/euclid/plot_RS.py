...
for jj, p2_data in enumerate(p2_all_dat):
    ...
    plt.figure(11, (7.4,7.5))
    s1 = (RES[jj]['intWTH_1Mpc']!=np.inf)&(RES[jj]['intWTH_1Mpc']>0.0)
    ...
    plt.plot(RES[jj]['color_grid'][s1]+color_step/2., RES[jj]['intWTH_1Mpc'][s1], label=r'DATA $R_{max}=500kpc$', ls='', marker='x', color='darkred') #  , xerr=color_step/2., yerr=[RES[jj]['intWTH_1Mpc'][s1]-RES[jj]['intWTH_1Mpc_lo'][s1], RES[jj]['intWTH_1Mpc_up'][s1]-RES[jj]['intWTH_1Mpc'][s1]])
    plt.fill_between(RES[jj]['color_grid']+color_step/2., RES[jj]['intWTH_1Mpc_lo'], RES[jj]['intWTH_1Mpc_up'], color='darkred', alpha=0.3)
    ...
    plt.plot(RES[jj]['color_grid'][s1]+color_step/2., RES[jj]['intWTH_1Mpc'][s1]/y_model, label=r'DATA/ fit model', ls='--', marker='o', color='darkred')
    ...
    plt.plot(RES[jj]['color_grid'][s1]+color_step/2., RES[jj]['intWTH_1Mpc'][s1]/y_MK24, label=r'DATA / RS model MK24', ls='--', marker='s', color='k')
...
plt.plot(z_RS, gr_RS+gr_RS_sigma, 'k:', lw=2)
plt.plot(params_WT[-1], params_WT[3], 'r--', lw=2,label=r'fit $\int [w(r<500kpc))$',c='darkred')
